...
config = {
    ...
    "PROMPT": "What was the price range of a barrel of oil in 2015? Options: $35 - $65, $48.36 - $60.95, $37.04 - $48.36, $37.04 - $60.95, Omit. Choose only one option as the answer without explanation.",
    "QUESTION_TYPE": "Determine_Range",
...
def run_chartgemma():
    ...
    output_file = "Final_chartgemma__Determine_Range.csv"
...
def run_gemini(model_type):
    output_file = f"Final_{model_type}_Determine_Range.csv"
    with open(output_file, mode='w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(["Index", "Image", "Question Type", "Prompt", "Question Description", "Model Name", "Color",
                         "Chart Title", "Image Path", "Ground Truth", "Prediction", "Answer Time"])
...
def run_chatgpt_vision():
    ...
    output_file = "Final_chatgpt_Determine_Range.csv"
